...
function getLatitude(latitudeE7) {
    ...
    return Number.parseFloat(latitude.toFixed(6));
}
...
function getLongitude(longitudeE7) {
    ...
    return Number.parseFloat(longitude.toFixed(6));
}
...
function getRadian(degree) {
    ...
    return Number.parseFloat(radian.toFixed(6));
}

// Method to find the air distance between two points (Haversine Distance)
// Unit in meters
// Error upto 300m
function getHaversineDistance(latitude1, longitude1, latitude2, longitude2) {
