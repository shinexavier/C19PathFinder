...
// This alias is to avoid the Grid module provided by nativebase
import { Grid as ChartGrid } from 'react-native-svg-charts';
...
const data = [5, 5, 8, 10, 14, 19, 22, 23, 24, 26, 30, 28, 32, 20, 80];
const xAxisLabels = ['Mar 01', 'Mar 05', 'Mar 10', 'Mar 15', 'Mar 20'];
...
const DashboardScreen: () => React$Node = props => {
    ...
    const [deceasedCases, setDeceasedCases] = useState();
    //let stateData = []
    ...
    function chosenState(val) {
        ...
        for (let i = 0; i < stateData.length; i++) {
            ...
            if (stateData[i].state === val) {
                console.log('data ', stateData[i]);
                //setFinalNumbers(stateData[i]);
                let cc =
                    stateData[i].confirmedCases.foreign +
                    stateData[i].confirmedCases.indian;
    ...
    function setIntensityColor(state) {
        let totalConfirmed = 0;
        // default colour
        let color = intensity[0].color;
        for (let i = 0; i < stateData.length; i++) {
            //console.log(stateData[i].state);
            if (stateData[i].state.toLowerCase() === state.toLowerCase()) {
                totalConfirmed =
                    stateData[i].confirmedCases.indian +
                    stateData[i].confirmedCases.foreign;
                for (let j = 0; j < intensity.length; j++) {
                    if (
                        totalConfirmed >= intensity[j].min &&
                        totalConfirmed <= intensity[j].max
                    ) {
                        color = intensity[j].color;
                    }
                }
                break;
            }
    ...
    function Legend() {
        return intensity.map((intense, index) => (
            <>
                <Rect
                    x={intense.legendPosition.rect.x}
                    y={intense.legendPosition.rect.y}
                    width="70"
                    height="15"
                    stroke={intense.color}
                    fill={intense.color}
                />
                <SvgText
                    fill="#696969"
                    stroke="#696969"
                    fontSize="20"
                    x={intense.legendPosition.text.x}
                    y={intense.legendPosition.text.y}
                >
                    {index === intensity.length - 1 && intense.min + '+'}
                    {index < intensity.length - 1 &&
                        intense.min + ' - ' + intense.max}
                </SvgText>
            </>
        ));
    }
                                ...
                                <Row>
                                    ...
                                    >
                                        ...
                                        <Path
                                            ...
                                            fill={setIntensityColor('Gujarat')}
                                            title="Gujarat"
                                        ...
                                        <Path
                                            ...
                                            fill={setIntensityColor('Haryana')}
                                            title="Haryana"
                                        ...
                                        <Path
                                            ...
                                            fill={setIntensityColor('Manipur')}
                                            title="Manipur"
                                        ...
                                        <Path
                                            ...
                                            fill={setIntensityColor('Mizoram')}
                                            title="Mizoram"
                                        ...
                                        <Path
                                            onPress={() => {
                                                chosenState('Nagaland');
                                            }}
                                            fill={setIntensityColor('Nagaland')}
                                            title="Nagaland"
                                        ...
                                        <Path
                                            ...
                                            fill={setIntensityColor('Tripura')}
                                            title="Tripura"
